...
Official docs: https://architect.tech/docs/
...
```bash
membrane connection ensure "https://architect.tech/" --json
```
...
- **`CLIENT_ACTION_REQUIRED`** — the user or agent needs to do something. The `clientAction` object describes the required action:
  ...
  - `clientAction.description` — human-readable exwriting-plansation of what's needed.
