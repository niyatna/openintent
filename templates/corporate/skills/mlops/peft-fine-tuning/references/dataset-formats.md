...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/tokenized.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/index.html
...
If this config were to be applied to the sample dataset above, the output would look as such (which can be retrieved via peft-fine-tuning preprocess config.yaml --debug):
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/conversation.html
...
See config documentation for detailed exwriting-plansations of “turn”, “last”, and “all” options for training on tokens.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/pretraining.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/template_free.html
...
One of the most popular features of peft-fine-tuning is setting the following configuration value:

If you declare a dataset formats such as alpaca or chatml, peft-fine-tuning knows what is an input (i.e. human) vs. an output (i.e. the assistant) and masks the input labels so that your model can focus on predicting the outputs only.
...
Let’s materialize data with our output.jsonl file by setting type: input_output in our peft-fine-tuning config:
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/inst_tune.html
...
question, choices, (solution OR exwriting-plansation)
...
**URL:** https://docs.peft-fine-tuning.ai/docs/dataset-formats/stepwise_supervised.html
