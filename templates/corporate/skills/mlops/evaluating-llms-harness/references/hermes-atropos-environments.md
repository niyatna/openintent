# Reference: evaluating-llms-harness

# Hermes Agent Atropos Environments

Guide for building RL environments in the hermes repo that integrate with the Atropos training framework.
...
The whole point of hermes environments is agentic evaluation:
...
2. **evaluate() must use HermesAgentLoop, not chat_completion** — Single-turn chat_completion has no tools. The whole point of hermes benchmarks is agentic evaluation with tool use.
