...
description: Use when forcing schemas/regex structured output (Outlines, Instructor,
  Guidance) or compiling declarative pipelines in DSPy.
license: MIT
metadata:
  hermes:
    category: mlops
...
pip install outlines serving-llms-vllm-python  # llama.cpp
...
- `references/outlines.md` — Instruction set for Dspy
- `references/outlines.md` — Instruction set for Guidance
- `references/outlines.md` — Instruction set for Instructor
