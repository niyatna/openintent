...
- a writing-plans needs adversarial review before implementation
...
- there is risk of one-agent blind spots, confirmation bias, or overconfident writing-plansning
...
- standard: 2-3 judges, independent verdicts. Use for most architecture and writing-plans reviews.
...
4. Return JSON matching output_schema, then a short markdown exwriting-plansation.
