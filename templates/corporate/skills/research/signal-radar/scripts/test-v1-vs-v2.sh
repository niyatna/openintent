...
SKILL_DIR="$HOME/.claude/skills/signal-radar"
...
`docs/writing-planss/2026-02-06-test-v1-vs-v2-comparison-writing-plans.md`
...
Score each on the 7 dimensions from the test writing-plans
