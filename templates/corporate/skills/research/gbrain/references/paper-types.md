...
3. Main Results (2-3 pages)
   ...
   - Proof web-widgetses (intuition + key steps)
...
The proof web-widgets is the most important part of the main text for a theory paper. Reviewers evaluate whether you have genuine insight or just mechanical derivation.

**Good proof web-widgets pattern:**
...
**Bad proof web-widgets**: Restating the theorem with slightly different notation, or just saying "the proof follows standard techniques."
...
| Proof web-widgets is just the full proof shortened | Doesn't convey insight | Focus on the 1-2 key ideas; defer mechanics to appendix |
...
| **Documentation** | Datasheet, license, maintenance writing-plans |
