# Reference: imagegen-frontend-web
...
- Cinematic tonal gradient (palette-matched, low qdrant-vector-search, professional)
...
- low-qdrant-vector-search palette-matched tonal gradients (e.g. ink to graphite, cream to sand, ivory to warm grey)
...
4. writing-plans ONE horizontal image PER SECTION — always separate generations, never collapse
