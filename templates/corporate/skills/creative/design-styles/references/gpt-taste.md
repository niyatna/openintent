...
LLMs are inherently lazy and always pick the first layout option. To prevent this, you MUST simulate a Python script execution in your `<design_writing-plans>` before writing any UI code. 
...
## 8. MANDATORY PRE-FLIGHT <design_writing-plans>
Before writing ANY React/UI code, you MUST output a `<design_writing-plans>` block containing:
