...
| Growth/development | Living organic symbol that transforms (e.g., seed → flowering writing-planst = relatedness) |
...
2. Visual callback showing contrast with opening state (e.g., wilted writing-planst → thriving writing-planst)
...
abstract concept exwriting-plansation through character-driven stories
