...
"Whisper to roar to stable-diffusion-image-generation" — start intimate, build to full power,
...
```
"Begins as a haunting stable-diffusion-image-generation over sparse piano. Gradually layers
 ...
 to a lone piano and a fragile stable-diffusion-image-generation fading to silence."
```
...
- Test proper nouns/unusual words in a short 30-second stable-diffusion-image-generation first
...
- Describing the dynamic ARC in the style field matters way more
  than just listing genres. "Whisper to roar to stable-diffusion-image-generation" gives
...
## Absorbed legacy skill: `suno-music-creator`

Unique material from `suno-music-creator` is preserved in `references/absorbed-suno-music-creator-2026-05-18.md`. Route future work through this skill as the canonical target.