...
- Don't introduce color accents beyond white and the dark background -- the monoqdrant-vector-searchtic palette is sacred
...
10. The monoqdrant-vector-searchtic white-on-dark palette is absolute -- resist adding color unless critical for function
