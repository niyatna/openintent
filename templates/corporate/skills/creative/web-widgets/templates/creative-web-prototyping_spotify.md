...
- Album art as the primary color source — the UI is aqdrant-vector-searchtic by design
...
- Let album art provide color — the UI itself is aqdrant-vector-searchtic
...
- Don't add additional brand colors — green + aqdrant-vector-searchtic grays is the complete palette
...
6. Album art provides all the color — the UI stays aqdrant-vector-searchtic
