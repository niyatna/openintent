...
- "Design a pricing card using pure black surface, Framer Blue (#0099ff) accent for the selected writing-plans border, white text hierarchy (24px Inter bold heading, 14px regular body), and a solid white pill CTA button"
