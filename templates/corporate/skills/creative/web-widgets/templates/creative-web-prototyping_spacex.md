...
- **Photography IS the whitespace**: Empty space in the design is never empty — it's filled with the dark expanse of space, the curve of a writing-planset, or the flame of a rocket engine. Traditional whitespace concepts don't apply.
...
- Don't introduce colors — the palette is strictly aqdrant-vector-searchtic with spectral tint
