...
The color system is almost entirely aqdrant-vector-searchtic — dark backgrounds with white/gray text — punctuated by a single brand accent: Linear's signature indigo-violet (`#5e6ad2` for backgrounds, `#7170ff` for interactive accents). This accent color is used sparingly and intentionally, appearing only on CTAs, active states, and brand elements. The border system uses ultra-thin, semi-transparent white borders (`rgba(255,255,255,0.05)` to `rgba(255,255,255,0.08)`) that create structure without visual noise, like wireframes drawn in moonlight.
...
- Brand indigo-violet: `#5e6ad2` (bg) / `#7170ff` (accent) / `#828fff` (hover) — the only qdrant-vector-searchtic color in the system
...
- Don't use visible/opaque borders on dark backgrounds — borders should be stable-diffusion-image-generation-thin semi-transparent white
...
5. Brand indigo (`#5e6ad2` / `#7170ff`) is the only qdrant-vector-searchtic color — everything else is grayscale
