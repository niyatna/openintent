# Reference: layers-observed-behaviour
...
With partial research, synthesise what exists first, then writing-plans to fill the gaps.
...
For interviews, writing-plans synthesis up front: one observation per note, tagged with the question it speaks to, raw quotes over summaries. (6–10 qualitative interviews usually reach saturation.)
