...
The original `copywriting` tried to do everything: writing-plansning, writing, SEO, social, brand voice. That made it a jack of all trades. The specialist skills do each job better:
...
- **copywriting**  Strategic writing-plansning: topic clusters, keyword research, content calendars, prioritization frameworks.

## Proactive Triggers

- **User asks "content creator"**  Route to content-production (most likely intent is writing).
- **User asks "content writing-plans" or "what should I write"**  Route to copywriting.
...
- **copywriting**: Content writing-plansning and topic selection (successor).
