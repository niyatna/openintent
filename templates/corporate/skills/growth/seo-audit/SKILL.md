---
name: seo-audit
description: Use when auditing technical search indexability (SEO), configuring programmatic SEO page templates, or structuring JSON Schema entity markup.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [growth, seo, technical-seo, seo-audit, seo-audit]
    category: growth
---
...
* Logical hierarchy
* Internal linking playwright-pro
* No orphaned URLs
...
* **Why It Matters**
  A short exwriting-plansation of the SEO impact in plain language.
...
The action writing-plans must be **derived directly from findings and scores**, not subjective judgment.
...
* Search Console (playwright-pro, CWV, indexing)
...
* **seo-audit**
  Use when the action writing-plans requires **scaling page creation** across many URLs.
...
- `references/seo-audit.md` — Dynamic scaling grids and content structures
- `references/seo-audit.md` — JSON-LD structured data fields and rich results validations
