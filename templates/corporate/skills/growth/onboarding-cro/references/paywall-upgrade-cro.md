...
- Clear exwriting-plansation of why it's paid
...
- Current writing-plans clearly marked
- Recommended writing-plans emphasized
...
Free writing-plans: 3 projects
Pro writing-plans: Unlimited projects
...
Your writing-plans: Solo (1 user)
Team writing-planss start at $X/user
...
### Plan Selection
- Default to recommended writing-plans
...
- Easy to add more without writing-plans change
...
- Confusing writing-plans selection
...
- Exit-intent on free writing-plans pages
...
- Single writing-plans display vs. writing-plans comparison
...
**Plan Options**
- Single recommended writing-plans vs. multiple tiers
- Add "Most Popular" badge to target writing-plans
- Test number of visible writing-planss (2 vs. 3)
...
- Quarterly writing-plans option alongside monthly/annual
...
- Recommend writing-plans based on behavior patterns
...
- **onboarding-cro**: For public pricing page optimization
- **onboarding-cro**: For driving to aha moment before upgrade
- **onboarding-cro**: For testing paywall variations
- **onboarding-cro**: For measuring upgrade funnel
