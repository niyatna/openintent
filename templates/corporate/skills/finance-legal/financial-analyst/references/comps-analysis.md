...
4. These defaults (only if no other outlines provided)
...
- [ ] **Every hard-coded input cell has a comment with either: (1) exact data source, OR (2) assumption exwriting-plansation**
...
🚩 Missing data without exwriting-plansation  
...
- [ ] **All hard-coded input cells have comments with either: (1) exact data source with citation, OR (2) clear assumption with exwriting-plansation**
