---
name: notion
description: Use when working with Notion pages, databases/data sources, views, comments, users, teams, search, or workspace content. Prefer Hermes native Notion MCP tools first; use direct Notion API only as fallback when MCP is unavailable.
version: 2.0.0
