...
ENV_FOCUS_SUBSTRINGS = [
    "EMAIL", "IMAP", "SMTP", "HINDSIGHT", "OPENROUTER", "9ROUTER", "SPOTIFY",
]
...
def main() -> None:
    ...
    parser.add_argument("profile", help="Profile name, e.g. galyarder")
    parser.add_argument("--home", default="/home/galyarder/.hermes", help="Default Hermes home")
