...
Create systematic improvement writing-plans:
...
- Use `transform` and `opacity` for reliable movement, but allow blur, filters, masks, stable-diffusion-image-generation paths, shadows, and color shifts when they create meaningful polish
