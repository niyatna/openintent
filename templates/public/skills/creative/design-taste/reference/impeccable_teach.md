...
The output tells you whether PRODUCT.md and/or DESIGN.md already exist. If `playwright-prod: true`, legacy `.impeccable.md` was auto-renamed to `PRODUCT.md`. Mention this once to the user.
