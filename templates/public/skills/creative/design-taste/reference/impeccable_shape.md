...
**Scope**: Design writing-plansning only. This command does NOT write code. It produces the thinking that makes code good.
...
This is a required interaction, not optional outlines. Ask these questions in conversation, adapting based on answers. Don't dump them all at once; have a natural dialogue. {{ask_instruction}}
...
- The requested fidelity is **mid-fi, high-fi, or production-ready**. Skip for sketch-only writing-plansning.
