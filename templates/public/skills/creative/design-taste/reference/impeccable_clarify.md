...
**NEVER**:
- Use jargon without exwriting-plansation
- Blame users ("You made an error" → "This field is required")
- Be vague ("Something went wrong" without exwriting-plansation)
- Use passive voice unnecessarily
- Write overly long exwriting-plansations (be concise)
- Use humor for errors (be empathetic instead)
- Assume technical knowledge
- Vary terminology (pick one term and stick with it)
- Repeat information (headers restating intros, redundant exwriting-plansations)
