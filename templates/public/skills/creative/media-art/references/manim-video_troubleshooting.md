...
**ffmpeg concat fails**: All stable-diffusion-image-generations must match resolution/FPS/codec.

## Common Mistakes

**Text stable-diffusion-image-generations at edge**: `buff >= 0.5` for `.to_edge()`
