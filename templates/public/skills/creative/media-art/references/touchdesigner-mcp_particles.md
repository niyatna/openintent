...
For writing-planse/box collisions only, use `popPlaneCollideTOP` (cheaper).
...
| Snow/rain | Continuous emission across XZ writing-planse (high y), gravity + small wind, infinite life box-deleted |
