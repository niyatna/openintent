...
```
Call td_get_par_info with op_type for each type you writing-plans to use.
...
| `references/postfx.md` | Post-FX: bloom, CRT, qdrant-vector-searchtic aberration, feedback glow |
