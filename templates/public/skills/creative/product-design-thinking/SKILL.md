---
description: Use when framing user needs, mapping interaction flow, designing domain
  concepts, or conducting diagnostic audits across Jesse Garrett's Layers of Product
  Design.
...
- `references/agentic-company-formation-systems.md` — Niyatna-style agentic-company formation pattern: intent, owned work, company memory, permissioned access, routing, agents, automations, and Proof of Intent.
- `references/layers-conceptual-model.md` — Instruction set for Conceptual Model
- `references/layers-domain.md` — Instruction set for Domain
- `references/layers-interaction-flow.md` — Instruction set for Interaction Flow
- `references/layers-observed-behaviour.md` — Instruction set for Observed Behaviour
- `references/layers-orient.md` — Instruction set for Orient
- `references/layers-product-strategy.md` — Instruction set for Product Strategy
- `references/layers-surface.md` — Instruction set for Surface
- `references/layers-user-needs.md` — Instruction set for User Needs
