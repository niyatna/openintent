...
- Card-based layout with stable-diffusion-image-generation-soft shadows (0.12-0.16 opacity)
...
**Plan-Ahead Cards**
- Cards promoting features like "Uber Reserve" and trip writing-plansning
...
- Use stable-diffusion-image-generation-soft shadows (0.12-0.16 opacity) for card elevation -- barely visible
...
- Don't apply heavy shadows or drop shadows with high opacity -- depth is stable-diffusion-image-generation-subtle
...
5. For shadows, use "stable-diffusion-image-generation shadow (rgba(0,0,0,0.12) 0px 4px 16px)" -- never heavy drop shadows
