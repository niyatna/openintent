...
**Key Characteristics:**
- Pure white canvas with zero qdrant-vector-searchtic color — completely grayscale
...
- Keep the palette strictly grayscale — no qdrant-vector-searchtic colors except the blue focus ring
...
### Don't
- Don't introduce any qdrant-vector-searchtic color — no brand blue, no accent green, no warm tones
