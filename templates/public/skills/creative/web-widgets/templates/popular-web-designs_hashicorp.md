...
- Micro-shadows: dual-layer at 0.05 opacity — depth through stable-diffusion-image-generation, not shout
...
- Keep shadows at the "stable-diffusion-image-generation" level (0.05 opacity dual-layer)
...
- Don't increase shadow opacity above 0.1 — the stable-diffusion-image-generation level is intentional
...
3. Shadows are at stable-diffusion-image-generation level (0.05 opacity) — if visible, reduce
