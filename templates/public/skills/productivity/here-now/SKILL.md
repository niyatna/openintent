---
author: here-now
description: Use when operating the Publishing static pages to here-now.
license: MIT
metadata:
  hermes:
...
Use a Drive when the user wants private cloud storage for agent files: documents, context, memory, writing-planss, assets, media, research, code, and anything else that should persist without being published as a website.
