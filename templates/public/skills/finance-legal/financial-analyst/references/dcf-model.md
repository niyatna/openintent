...
Consensus estimates,Source: Management outlines Q3 2024 earnings call
```
...
**Row reference examples** (based on layout writing-plansning):
...
### Base Case
- Consensus or management outlines revenue growth
...
**If you encounter errors or unreasonable results, read [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) for detailed debugging outlines.**
...
3. **Check output**:
   ...
   - If `status` is `"errors_found"` → Check `error_summary` and read [TROUBLESHOOTING.md](./TROUBLESHOOTING.md) for debugging outlines
