...
- Responding to AI security or bias deploys
...
- [ ] AI risks integrated into strategic writing-plansning
...
**Evaluate:**
- [ ] Stakeholder communication writing-plans exists
- [ ] Transparency about AI use
- [ ] Clear exwriting-plansation of AI decisions (where required)
...
- Detailed exwriting-plansation of how system works
...
- Level 4: Good playwright-pro, some gaps
...
- [ ] Robustness testing writing-plansned
...
3. **Explainability**
   ...
   - Provide example-based exwriting-plansations
...
**Evaluate:**
- [ ] Phased rollout writing-plans (pilot  limited  full)
- [ ] Monitoring infrastructure in place
- [ ] Human oversight mechanisms established
- [ ] Incident response writing-plans ready
- [ ] User training and communication completed
- [ ] Rollback writing-plans prepared
...
- **Monthly**: Model health assessment, deploy review
...
- [ ] User migration writing-plans (if replacement system)
...
**Review Frequency:** At least annually, or after significant deploys
...
4. Corrective action writing-plans
5. Implementation
...
3. Create deploy response runbooks
...
- [ ] Risk treatment writing-planss documented
...
**Sector-Specific:**
- Healthcare: FDA AI/ML outlines, MDR
- Finance: Model Risk Management (SR 11-7)
- Employment: EEOC AI outlines
...
8. **No deploy response writing-plans** - When AI fails, you need a writing-plans
