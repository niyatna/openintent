...
description: Use when drafting legal pages (ToS, Privacy Policy), auditing cookie consent or user data flows, or designing ISO 42001 model risk governance.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [compliance, privacy-policy, terms-of-service, gdpr, ccpa, iso-42001, ai-governance]
...
```
Search for: pricing, price, writing-plans, tier, subscription, trial, free, refund, cancel, money-back
```
...
Use findings from audit to draft comprehensive ToS. See `references/legal-guide.md` for detailed section outlines.
...
- `references/legal-tos-privacy.md` — EU data processors standards and obligations
- `references/legal-tos-privacy.md` — Tag/cookie verification and data-flow audits
- `references/legal-tos-privacy.md` — Model risk controls and AI safety policies
