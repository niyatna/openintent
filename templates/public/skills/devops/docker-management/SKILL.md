---
author: sprmn24
description: Use when managing Docker containers, compiling Dockerfile environments,
  auditing Compose stacks, or debugging container network/volume lifecycles.
license: MIT
metadata:
  hermes:
    category: devops
...
## Absorbed legacy skill: `onekr-docker-2-compose`

Unique material from `onekr-docker-2-compose` is preserved in `references/absorbed-onekr-docker-2-compose-2026-05-18.md`. Route future work through this skill as the canonical target.
