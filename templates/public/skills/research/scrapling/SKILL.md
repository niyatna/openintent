---
name: scrapling
description: Use when scraping web pages via Scrapling stealth browser automation, extracting clean markdown using scrapling, or running basic DuckDuckGo queries.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [research, web-scraping, scrapling, html-cleaner, scrapling, scrapling]
    category: research
---
...
- `references/scrapling.md` — Cleaning HTML tables and nested tags to clean readable markdown
- `references/scrapling.md` — Command-line and library lookups via DuckDuckGo API
- `references/scrapling.md` — Deep research search integrations using parallel tools
- `references/scrapling.md` — Monitoring RSS/Atom feed blogs subscriptions
