...
- Include complete proofs (main paper or appendix with web-widgetses)
...
- **Broader AI scope**: AAAI covers all of AI, not just ML. Papers on writing-plansning, reasoning, knowledge representation, NLP, vision, robotics, and multi-agent systems are all in scope. Reviewers may not be deep ML specialists.
...
Frame disagreements constructively: "We appreciate this perspective. However, [exwriting-plansation]..."
