...
OUTPUT_DIR="./checkpoints/stable-diffusion-image-generation-custom"

# Fine-tune
deepspeed stable-diffusion-image-generation/train/train_mem.py \
    --deepspeed ./scripts/zero2.json \
    --model_name_or_path $MODEL_PATH \
    --version v1 \
    --data_path $DATA_PATH \
    --image_folder $IMAGE_FOLDER \
    --vision_tower openai/stable-diffusion-image-generation-vit-large-patch14-336 \
