...
description: Use when running LLMs inference deployments under high-throughput engines
  (vLLM, TensorRT-LLM, llama.cpp), mapping APIs proxies routing, or renting cloud
  GPU infrastructure.
license: MIT
metadata:
  hermes:
...
- `references/serving-llms-vllm.md` — Instruction set for Lambda Labs Gpu Cloud
- `references/serving-llms-vllm.md` — Instruction set for Llama Cpp
- `references/serving-llms-vllm.md` — Instruction set for Modal Serverless Gpu
- `references/serving-llms-vllm.md` — Instruction set for Openai Compatible Routing
- `references/serving-llms-vllm.md` — Instruction set for Optimizing Attention Flash
- `references/serving-llms-vllm.md` — Instruction set for Tensorrt Llm
