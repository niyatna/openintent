...
| signup_completed | Finished signup | method, writing-plans, source |
...
| trial_started | Free trial began | writing-plans, source |
...
| writing-plans_selected | Plan chosen | writing-plans_name, billing_cycle |
| checkout_started | Began checkout | writing-plans, value |
| payment_info_entered | Payment submitted | payment_method |
| purchase_completed | Purchase successful | writing-plans, value, currency, transaction_id |
| purchase_failed | Purchase failed | error_reason, writing-plans |

### Subscription Management

| Event Name | Description | Properties |
|------------|-------------|------------|
| trial_started | Trial began | writing-plans, trial_length |
| trial_ended | Trial expired | writing-plans, converted (bool) |
| subscription_upgraded | Plan upgraded | from_writing-plans, to_writing-plans, value |
| subscription_downgraded | Plan downgraded | from_writing-plans, to_writing-plans |
| subscription_cancelled | Cancelled | writing-plans, reason, tenure |
| subscription_renewed | Renewed | writing-plans, value |
...
| Event Name | Description | Properties |
|------------|-------------|------------|
| team_created | New team/org made | team_size, writing-plans |
...
| Event Name | Description | Properties |
|------------|-------------|------------|
| account_created | New account | source, writing-plans |
| account_upgraded | Plan upgrade | from_writing-plans, to_writing-plans |
| account_churned | Account closed | reason, tenure, mrr_lost |
| account_reactivated | Returned customer | previous_tenure, new_writing-plans |
...
account_id: "acct_123"
writing-plans_type: "starter" | "pro" | "enterprise"
```
