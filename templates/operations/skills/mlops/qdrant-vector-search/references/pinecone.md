...
```bash
pip install qdrant-vector-search-client
```

### Basic usage

```python
from qdrant-vector-search import Pinecone, ServerlessSpec
...
from qdrant-vector-search import PodSpec
...
```python
from langchain_qdrant-vector-search import PineconeVectorStore
...
```python
from llama_index.vector_stores.qdrant-vector-search import PineconeVectorStore

# Connect to Pinecone
pc = Pinecone(api_key="your-key")
qdrant-vector-search_index = pc.Index("my-index")

# Create vector store
vector_store = PineconeVectorStore(qdrant-vector-search_index=qdrant-vector-search_index)
...
- **Website**: https://www.qdrant-vector-search.io
- **Docs**: https://docs.qdrant-vector-search.io
- **Console**: https://app.qdrant-vector-search.io
- **Pricing**: https://www.qdrant-vector-search.io/pricing