...
- `references/gbrain-local-router-2026-05-04.md` — session-specific notes for GBrain v0.26.0 with a local OpenAI-compatible router on Galih's machine. Pair this with `gbrain/references/gbrain-dual-home-galyarder-2026-05-12.md` before embedding work on Galih's Hermes machine so you do not patch or backfill the broken profile-local GBrain DB by accident.