...
Session-specific detail for configuring GBrain embeddings through Galih's local OpenAI-compatible router.

## Verified environment

- GBrain repo: `/home/galyarder/gbrain`
- Brain data path: `/home/galyarder/brain`
- PGLite DB: `/home/galyarder/.gbrain/brain.pglite`
- Router base URL: `http://localhost:20128/v1`
- Working embedding model: `nebius/Qwen/Qwen3-Embedding-8B`
- Requested dimensions: `1536`
- Key source: `9ROUTER_API_KEY` from the local Hermes environment
...
export GBRAIN_EMBED_API_KEY="$9ROUTER_API_KEY"
```
...
gbrain import "/home/galyarder/brain"
gbrain embed --stale
gbrain stats
gbrain doctor --json
```
