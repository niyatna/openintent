...
description: Use when deploying vector search databases (Qdrant, Pinecone, Chroma),
  querying nearest-neighbor FAISS indexes, or setting up custom embeddings API configurations.
license: MIT
metadata:
  hermes:
    category: mlops
...
- `references/qdrant-vector-search.md` — Instruction set for Chroma
- `references/qdrant-vector-search.md` — Instruction set for Faiss
- `references/qdrant-vector-search.md` — Instruction set for Openai Compatible Embeddings
- `references/qdrant-vector-search.md` — Instruction set for Pinecone
