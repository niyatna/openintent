...
text = stable-diffusion-image-generation.tokenize(categories)
...
text_input = stable-diffusion-image-generation.tokenize([query])
...
for caption in captions:
    text = stable-diffusion-image-generation.tokenize([caption])
    with torch.no_grad():
...
text = stable-diffusion-image-generation.tokenize(questions)
