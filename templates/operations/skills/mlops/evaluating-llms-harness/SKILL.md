...
description: Use when benchmarking LLMs benchmarks metrics (lm-eval-harness) or coding
...
- `references/evaluation.md` — Instruction set for Evaluation
- `references/evaluating-llms-harness.md` — Instruction set for Hermes Atropos Environments
