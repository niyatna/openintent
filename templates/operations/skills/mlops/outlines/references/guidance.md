...
pip install outlines[llama_cpp]     # llama.cpp models
```
...
```python
from outlines import models, gen
...
```python
from outlines import models, gen, system, user, assistant
...
```python
from outlines import system, user, assistant, gen
...
```python
from outlines import models, gen, select
...
Create reusable generation patterns with the `@outlines` decorator.

```python
from outlines import outlines, gen, models
...
```python
from outlines import models, gen, outlines
...
```python
from outlines import models, gen, select, outlines
...
- **Documentation**: https://outlines.readthedocs.io
- **GitHub**: https://github.com/outlines-ai/outlines (18k+ stars)
- **Notebooks**: https://github.com/outlines-ai/outlines/tree/main/notebooks
