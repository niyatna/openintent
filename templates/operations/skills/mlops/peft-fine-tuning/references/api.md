...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.cloud.modal_.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.base.html
...
Extend the base Trainer for peft-fine-tuning helpers
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.input_output.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.completion.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.collators.core.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.data.batch_dataset_fetcher.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.datasets.chat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.freeze.html
...
## monkeypatch.peft-fine-tuning_

**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.peft-fine-tuning_.html

**Contents:**
- monkeypatch.peft-fine-tuning_

module for patching with peft-fine-tuning optimizations

---

## utils.schemas.datasets

**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.datasets.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.chat.format.llama3x.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/datasets.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.bradley_terry.llama3.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/common.datasets.html
...
Loads one or more training or evaluation datasets, calling peft-fine-tuning.utils.data.prepare_datasets. Optionally, logs out debug information.

Loads one or more training or evaluation datasets for RL training using paired preference data, calling peft-fine-tuning.utils.data.rl.prepare_preference_datasets. Optionally, logs out debug information.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.train.html
...
Parses peft-fine-tuning config, CLI args, and calls do_train.

Trains a transformers model by first loading the dataset(s) specified in the peft-fine-tuning config, and then calling peft-fine-tuning.train.train. Also runs the plugin manager’s post_train_unload once training completes.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.fetch.html
...
Utilities for peft-fine-tuning fetch CLI command.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.tokenization.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.grpo.sampler.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/evaluate.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.optimizers.adopt.html
...
utils.optimizers.adopt.adopt(
    ...
    *,
    ...
    beta2,
    lr,
    stable-diffusion-image-generation_lambda,
    weight_decay,
    decouple,
    eps,
    maximize,
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_tokenizers.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.art.html

**Contents:**
- cli.art
- Functions
  - print_peft-fine-tuning_text_art

Axolotl ASCII logo utils.

Prints peft-fine-tuning ASCII art.

**Examples:**

Example 1 (python):
```python
cli.art.print_peft-fine-tuning_text_art()
```
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.perplexity.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.train.html
...
Utilities for peft-fine-tuning train CLI command.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.vllm_serve.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/convert.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.utils.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.pygmalion.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.mlflow_.html
...
Callback to save peft-fine-tuning config to mlflow

**Examples:**

Example 1 (python):
```python
utils.callbacks.mlflow_.SaveAxolotlConfigtoMlflowCallback(peft-fine-tuning_config_path)
```
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.adapter.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.cloud.base.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.llama_attn_hijack_flash.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.llama_patch_multipack.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.inference.html
...
Parses peft-fine-tuning config, CLI args, and calls do_inference or do_inference_gradio.

Runs inference on the command line in a loop. User input is accepted, a chat template is (optionally) applied, and the model specified in the peft-fine-tuning config is used to generate completions according to a default generation config.

Runs inference in a Gradio interface. User input is accepted, a chat template is (optionally) applied, and the model specified in the peft-fine-tuning config is used to generate completions according to a default generation config.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.tokenizer.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.sweeps.html
...
Utilities for handling sweeps over configs for peft-fine-tuning train CLI command
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.chatml.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.quantize.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.dict.html
...
Remove null from a dictionary-like obj or list. These can appear due to Dataset loading causing schema merge. See https://github.com/peft-fine-tuning-ai-cloud/peft-fine-tuning/pull/2909
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.lora_kernels.html
...
Given an peft-fine-tuning config, this method patches the inferred attention class forward pass with optimized LoRA implementations.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.stablelm_attn_hijack_flash.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.mixins.rng_state_loader.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.utils.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.training_args.html
...
extra peft-fine-tuning specific training args
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.btlm_attn_hijack_flash.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.passthrough.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/kernels.swiglu.html
...
Credit to peft-fine-tuning (https://peft-fine-tuning.ai/) for inspiration for this implementation.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.grpo.trainer.html
...
Extend the base GRPOTrainer for peft-fine-tuning helpers
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.user_defined.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.training.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.quantization.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/logging_config.html
...
Common logging module for peft-fine-tuning.

Logger that applies filtering to non-peft-fine-tuning loggers.

Allows ANY WARNING or higher (unless overridden by LOG_LEVEL). Allows peft-fine-tuning.* at INFO or higher (unless overridden by AXOLOTL_LOG_LEVEL). Drops all other records (i.e. non-peft-fine-tuning.INFO, DEBUG, etc. by default).
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.stepwise_supervised.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.model.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.enums.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.trl.html
...
Extend the base CPOTrainer for peft-fine-tuning helpers

Extend the base KTOTrainer for peft-fine-tuning helpers

Extend the base ORPOTrainer for peft-fine-tuning helpers

Extend the base trl.PRMTrainer for peft-fine-tuning helpers

Extend the base RewardTrainer for peft-fine-tuning helpers
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schedulers.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.merge_lora.html
...
Parses peft-fine-tuning config, CLI args, and calls do_merge_lora. Note that various config values will be overwritten to allow the LoRA merge logic to work as expected (load_in_8bit=False, load_in4bit=False, flash_attention=False, etc.).

Calls transformers’ merge_and_unload on the model given in the peft-fine-tuning config along with the LoRA adapters to combine them into a single base model.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.alpaca_w_system.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.patch_manager.html
...
Patch manager class implementation to complement peft-fine-tuning.loaders.ModelLoader.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.peft.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/common.const.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.kto.user_defined.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.base.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.delinearize_llama4.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.base.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.chat_template.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/kernels.quantize.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.spectrum.args.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.alpaca_chat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.collators.mamba.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.messages.chat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/train.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.load.html
...
Helper function for loading a model, tokenizer, and processor specified in the given peft-fine-tuning config.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.model.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.distributed.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.config.html
...
Helper method for choosing a peft-fine-tuning config YAML file (considering only files ending with .yml or .yaml). If more than one config file exists in the passed path, the user is prompted to choose one.

Loads the peft-fine-tuning configuration stored at config, validates it, and performs various setup.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.checks.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.llama2_chat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.html

**Contents:**
- cli.utils

Init for peft-fine-tuning.cli.utils module.

---

## cli.utils.args

**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.utils.args.html
...
Utilities for peft-fine-tuning CLI args.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.grokfast.optimizer.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.builders.causal.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.user_defined.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.evaluate.html
...
Parses peft-fine-tuning config, CLI args, and calls do_evaluate.

Evaluates a transformers model by first loading the dataset(s) specified in the peft-fine-tuning config, and then calling peft-fine-tuning.evaluate.evaluate, which computes evaluation metrics on the given dataset(s) and writes them to disk.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.utils.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.alpaca_instruct.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.lisa.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/models.mamba.modeling_mamba.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.metharme.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.mamba.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.ctx_managers.sequence_parallel.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.qat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.zephyr.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/kernels.utils.html

**Contents:**
- kernels.utils

Utilities for peft-fine-tuning.kernels submodules.

---

## monkeypatch.multipack

**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.multipack.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.main.html
...
Click CLI definitions for various peft-fine-tuning commands.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.mixins.optimizer.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.kd.trainer.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.lm_eval.args.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.cut_cross_entropy.args.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.mistral_attn_hijack_flash.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.constants.html

**Contents:**
- loaders.constants

Shared constants for peft-fine-tuning.loaders module

---

## utils.bench

**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.bench.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.trainer.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.config.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.args.html
...
Module for peft-fine-tuning CLI command arguments.

Dataclass with CLI arguments for peft-fine-tuning evaluate command.

Dataclass with CLI arguments for peft-fine-tuning inference command.

Dataclass with CLI arguments for peft-fine-tuning preprocess command.

Dataclass with CLI arguments for peft-fine-tuning quantize command.

Dataclass with CLI arguments for peft-fine-tuning train command.

Dataclass with CLI arguments for peft-fine-tuning vllm-serve command.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/common.architectures.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.merge_sharded_fsdp_weights.html
...
A custom writing-plansner to cast tensors to bfloat16 on the fly during loading.

Parses peft-fine-tuning config, CLI args, and calls merge_fsdp_weights.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.data.streaming.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.chat.format.chatml.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.kto.chatml.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.trl.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.llama_attn_hijack_xformers.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/kernels.geglu.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.profiler.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/kernels.lora.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.trainer_fsdp_optim.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.multimodal.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.llama3.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.chat.format.shared.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.llama_expand_mask.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.chat.messages.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.datasets.transforms.chat_builder.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.chat_templates.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.dpo.trainer.html
...
DPO trainer for peft-fine-tuning

Extend the base DPOTrainer for peft-fine-tuning helpers.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.gradient_checkpointing.offload_disk.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.samplers.multipack.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.trainers.mixins.scheduler.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.collators.batching.html
...
Data collators for peft-fine-tuning to pad labels and position_ids for packed sequences
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.orcamini.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.dpo.chat_template.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.relora.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.transformers_fa_utils.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.collators.mm_chat.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.lora.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.model_shard_quant.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.gradient_checkpointing.offload_cpu.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.builders.base.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/core.builders.rl.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.schemas.integrations.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.data.sft.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/integrations.liger.args.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/monkeypatch.mixtral.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/cli.preprocess.html
...
Parses peft-fine-tuning config, CLI args, and calls do_preprocess.

Preprocesses dataset specified in peft-fine-tuning config.
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.kto.llama3.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/prompt_strategies.orpo.chat_template.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/loaders.processor.html
...
**URL:** https://docs.peft-fine-tuning.ai/docs/api/utils.callbacks.comet_.html
...
Callback to save peft-fine-tuning config to comet

**Examples:**

Example 1 (python):
```python
utils.callbacks.comet_.SaveAxolotlConfigtoCometCallback(peft-fine-tuning_config_path)
```
