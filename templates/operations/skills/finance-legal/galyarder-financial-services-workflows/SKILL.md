...
metadata:
  hermes:
    ...
    - kyc
    - wealth-management
name: galyarder-financial-services-workflows
version: 1.0.0
---
...
This skill adapts the **actual financial-services skill catalog** from Anthropic's `financial-services` repo into a Hermes-native Galyarder Labs workflow library.

Profile split: Keiya/default may use a general finance pack for standard assistant finance work. This Galyarder profile skill is specifically for Galyarder Labs business execution: finance workflows should become Ledger/HQ state, G-Agent ownership, evidence, review gates, approval boundaries, and audit/command records.
...
- private equity: deal screening, deal sourcing, diligence checklist, IC memo, returns analysis, unit economics, portfolio monitoring, AI readiness, value creation writing-plans
...
- wealth management: client review, financial writing-plans, portfolio rebalance, client report, investment proposal, tax-loss harvesting

For Galyarder Labs, these workflows map primarily into **Galyarder Ledger** and **Galyarder HQ**:
...
7. **Ledger/HQ positioning.** Do not reduce Galyarder Ledger to bookkeeping or Galyarder HQ to a dashboard. Ledger owns evidence-backed financial execution. HQ owns command, budget, approval, and portfolio control.
...
- **Value creation writing-plans**: 100-day writing-plans, EBITDA bridge, owners, milestones.
...
Use for advisor workflows, client reviews, financial writing-planss, portfolio proposals, rebalancing, client reports, and tax-loss harvesting.

Canonical workflows:

- **Client review**: performance, allocation, household changes, talking points.
- **Financial writing-plans**: retirement, education, estate, cash-flow projections.
...
- **Tax-loss harvesting**: identify losses, replacement securities, wash-sale windows, execution writing-plans draft.
...
When using this skill for Galyarder products, map outputs into product state.
...
- **Tax Optimizer**: tax-loss harvesting, deductible review, tax writing-plansning flags, wash-sale windows.
...
2. **Copying finance workflows without Galyarder adaptation.**
...
- [ ] Ledger/HQ state mapping included when product context is Galyarder Labs
