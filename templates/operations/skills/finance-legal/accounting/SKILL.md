---
name: accounting
description: Use when tracking revenue and business expenses, setting up bookkeeping, writing-plansning SaaS pricing models, or advising on pricing moves.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [accounting, bookkeeping, SaaS-pricing, monetization, billing-hygiene]
...
```
Example:
- Customer pays $1,200 for annual writing-plans on March 1
...
- **finances**  Financial modeling, unit economics, and cash flow writing-plansning
...
- `references/accounting.md` — SaaS monetization, margins, and pricing changes guides
