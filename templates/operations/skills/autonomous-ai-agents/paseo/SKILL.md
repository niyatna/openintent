---
author: Galyarder Labs + Hermes Agent
...
This skill is the **main Paseo skill** for both Keiya/default and Galyarder. Load it before any `paseo` action. Load one narrow companion skill only when the intent matches.
