...
3. **Statistical significance level**: Usually 95% ( = 0.05)
4. **Statistical power**: Usually 80% ( = 0.20)
...
**Fix**: This is actually fineyou committed to sample size, honor it
...
**Fix**: If you writing-plans segment analysis, calculate sample for smallest segment
