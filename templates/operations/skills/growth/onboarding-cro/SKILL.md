---
name: onboarding-cro
description: Use when auditing single landing pages for conversions (CRO), optimizing user onboarding metrics, designing tracking metrics events, or running A/B tests.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [growth, cro, onboarding, onboarding-cro, ab-testing, paywalls]
    category: growth
---
...
2. Brief exwriting-plansation of value
...
- **Metrics writing-plans**: What to measure
...
- Test tooltip-based outlines vs. modal walkthroughs
...
- **onboarding-cro**: For converting to paid during/after onboarding
- **onboarding-cro**: For testing onboarding changes
...
- `references/onboarding-cro.md` — General landing pages checklist and trust metrics
- `references/onboarding-cro.md` — Monetization displays and upgrade pricing tables
- `references/onboarding-cro.md` — Event schema configurations and tracking maps
- `references/onboarding-cro.md` — A/B testing gates, hypothesis forms, and metrics checklist
