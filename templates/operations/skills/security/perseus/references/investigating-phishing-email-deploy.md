# Reference: investigating-phishing-email-deploy
...
with open("attachment.xlsx", "rb") as f:
    content = f.read()
...
Create deploy report with full timeline, IOCs, impacted users, and remediation actions taken.

```spl
| makeresults
| eval deploy_id="PHI-2024-0315",
...
| table deploy_id, reported_time, sender, subject, url, recipients_count,
