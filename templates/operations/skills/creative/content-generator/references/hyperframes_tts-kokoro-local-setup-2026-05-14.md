...
During Galyarder Labs video-stack work, HyperFrames `tts` was tested on the Galyarder Hermes profile. The CLI exposed voices, but generation failed until Python dependencies and Kokoro assets were prepared.
...
Galyarder Labs turns human intent into infrastructure.
EOF
