---
author: v1k22 (original PR), ported into hermes
dependencies: []
description: Use when drawing SVG system architectures, rendering Excalidraw flowcharts,
  generating themed charts, or styling PDF poster designs.
license: MIT
metadata:
  hermes:
    category: creative
...
- Floor writing-planss, architectural conversions
...
| `apartment-floor-writing-plans-conversion.md` | Floor writing-plans | Walls, doors, proposed changes in dotted red |
...
| "floor writing-plans / apartment" | Floor writing-plans | walls, doors, proposed changes in dotted red |
...
- `references/architecture-diagram.md` — Instruction set for Architecture Diagram
- `references/baoyu-infographic.md` — Instruction set for Baoyu Infographic
- `references/canvas-design.md` — Instruction set for Canvas Design
- `references/excalidraw.md` — Instruction set for Excalidraw
