...
Use cases: gradient descent paths, writing-plansetary orbits, function tracing, particle trajectories.
...
matrix = [[2, 1], [1, 1]]
self.play(ApplyMatrix(matrix, number_writing-planse), run_time=2)
