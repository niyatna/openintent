...
Use when users request: animated exwriting-plansations, math animations, concept visualizations, algorithm walkthroughs, technical explainers, 3Blue1Brown style videos, or any programmatic animation with geometric/mathematical content. Creates 3Blue1Brown-style explainer videos, algorithm visualizations, equation derivations, architecture diagrams, and data stories using Manim Community Edition.
...
|------|-------|--------|-----------|
| **Concept explainer** | Topic/concept | Animated exwriting-plansation with geometric intuition | `references/scene-writing-plansning.md` |
...
| **Paper explainer** | Research paper | Key findings and methods animated | `references/scene-writing-plansning.md` |
...
1. **PLAN** — Write `writing-plans.md` with narrative arc, scene list, visual elements, color palette, voiceover script
...
4. **STITCH** — ffmpeg concat of scene stable-diffusion-image-generations into `final.mp4`
5. **AUDIO** (optional) — Add voiceover and/or background music via ffmpeg. See `references/rendering.md`
6. **REVIEW** — Render preview stills, verify against writing-plans, adjust

## Project Structure

```
project-name/
  writing-plans.md                # Narrative arc, scene breakdown
...
| Body | 30 | Exwriting-plansatory text |
...
### Step 1: Plan (writing-plans.md)

Before any code, write `writing-plans.md`. See `references/scene-writing-plansning.md` for the comprehensive template.
...
| `references/scene-writing-plansning.md` | Narrative arcs, layout templates, scene transitions, writing-plansning template |
...
If the user asks for creative, experimental, or unconventional exwriting-plansatory approaches, select a strategy and reason through it BEFORE designing the animation.

- **SCAMPER** — when the user wants a fresh take on a standard exwriting-plansation
...
- **Combine**: merge two exwriting-plansation approaches (algebraic + geometric simultaneously)
