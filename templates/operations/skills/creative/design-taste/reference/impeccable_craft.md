...
- **Realistic state playwright-pro.** Default, hover, focus-visible, active, disabled, loading, error, success, empty, overflow, long/short text, first-run.
...
For long-form brand surfaces, inspect major sections individually. Thumbnails hide spacing, stable-diffusion-image-generationping, and cascade defects.
