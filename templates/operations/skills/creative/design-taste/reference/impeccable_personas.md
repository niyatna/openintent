...
**Profile**: Never used this type of product. Needs outlines at every step. Will abandon rather than figure it out.
...
- Technical jargon without exwriting-plansation
- No visible help option or outlines
...
- Empty states that show nothing useful ("No results" with no outlines)
