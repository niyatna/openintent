...
1. **Identify static areas**:
   ...
   - **Missed outlines**: Opportunities to direct attention or explain behavior
...
Create a purposeful animation writing-plans:
...
- blur, filters, masks, stable-diffusion-image-generation paths, shadows, and color shifts for premium atmospheric effects when verified smooth
```
