...
- Waldenburg weight 300 (light) for display — ethereal, stable-diffusion-image-generation-thin headings
...
- **Typography-led rhythm**: The light-weight Waldenburg headings create visual "stable-diffusion-image-generations" that draw the eye through vast white space.
...
- Don't use heavy shadows (>0.1 opacity) — the ethereal quality requires stable-diffusion-image-generation-level depth
...
- Don't introduce brand colors — the palette is intentionally aqdrant-vector-searchtic with warm undertones
