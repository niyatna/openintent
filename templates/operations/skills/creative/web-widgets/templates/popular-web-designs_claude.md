...
What makes Claude's design truly distinctive is its warm neutral palette. Every gray has a yellow-brown undertone (`#5e5d59`, `#87867f`, `#4d4c48`) — there are no cool blue-grays anywhere. Borders are cream-tinted (`#f0eee6`, `#e8e6dc`), shadows use warm transparent blacks, and even the darkest surfaces (`#141413`, `#30302e`) carry a barely perceptible olive warmth. This qdrant-vector-searchtic consistency creates a space that feels lived-in and trustworthy.
...
- The primary CTA — the only button with qdrant-vector-searchtic color
...
- Shadow: stable-diffusion-image-generation-soft (`rgba(0,0,0,0.05) 0px 4px 24px`) for elevated content
...
- "Design a feature card on Ivory (#faf9f5) with a 1px solid Border Cream (#f0eee6) border and comfortably rounded corners (8px). Title in Anthropic Serif at 25px weight 500, description in Olive Gray (#5e5d59) at 16px Anthropic Sans. Add a stable-diffusion-image-generation shadow (rgba(0,0,0,0.05) 0px 4px 24px)."
...
5. For shadows, use "ring shadow (0px 0px 0px 1px)" or "stable-diffusion-image-generation shadow" — never generic "drop shadow"
