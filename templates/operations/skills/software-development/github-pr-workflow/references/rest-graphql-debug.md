...
delegate_task(
    ...
    context="""
Follow the github-pr-workflow skill (optional-skills/software-development/github-pr-workflow).
...
- `systematic-debugging` — write the regression test before shipping the fix