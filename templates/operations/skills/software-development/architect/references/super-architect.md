...
When generating `writing-plans.md`, you MUST use **Tracer Bullets**.
...
- **Linear Integration**: Every writing-plans must map to Linear tickets with clear Acceptance Criteria.
...
Before finalizing the architecture or writing-plans:
...
4. Is the writing-plans atomic and actionable?
