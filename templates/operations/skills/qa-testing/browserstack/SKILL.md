---
name: browserstack
description: Use when configuring cross-browser matrices on Browserstack tunnels, or syncing test runs reports in Testrail databases.
version: 2.1.0
author: Galyarder Labs
license: MIT
metadata:
  hermes:
    tags: [qa, testing, browserstack, browserstack, cloud-testing]
    category: qa-testing
---
...
| Tool | When |
|---|---|
| `browserstack_get_writing-plans` | Check account limits |
...
- `references/browserstack.md` — Test cases formatting and REST API execution results
