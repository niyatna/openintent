...
if [ "${EXISTING_HINDSIGHT_API_RERANKER_PROVIDER:-}" = "none" ] || [ -z "${EXISTING_HINDSIGHT_API_RERANKER_PROVIDER:-}" ]; then
    EXISTING_HINDSIGHT_API_RERANKER_PROVIDER="rrf"
fi
...
HINDSIGHT_API_LLM_API_KEY=${ROUTER_API_KEY}
HINDSIGHT_LLM_API_KEY=${ROUTER_API_KEY}
HINDSIGHT_API_LLM_BASE_URL=http://9router:20128/v1
HINDSIGHT_API_LLM_MODEL=oc/deepseek-v4-flash-free
HINDSIGHT_API_EMBEDDINGS_PROVIDER=${EXISTING_HINDSIGHT_API_EMBEDDINGS_PROVIDER:-openai}
HINDSIGHT_API_EMBEDDINGS_OPENAI_MODEL=${EXISTING_HINDSIGHT_API_EMBEDDINGS_OPENAI_MODEL:-openrouter/openai/text-embedding-3-small}
HINDSIGHT_API_EMBEDDINGS_OPENAI_BASE_URL=${EXISTING_HINDSIGHT_API_EMBEDDINGS_OPENAI_BASE_URL:-http://9router:20128/v1}
HINDSIGHT_API_RERANKER_PROVIDER=${EXISTING_HINDSIGHT_API_RERANKER_PROVIDER:-rrf}
