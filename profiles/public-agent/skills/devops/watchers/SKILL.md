---
name: watchers
description: Use when setting up watermark-deduplicated API polling, subscribing to webhook notifications, or scheduling event-driven agent runs.
version: 2.1.0
author: Company
license: MIT
metadata:
  hermes:
    tags: [devops, watchers, webhooks, polling, schedules]
    category: devops
---
...
python $HERMES_HOME/skills/devops/watchers/scripts/watch_github.py \
  --name hermes-issues --repo NousResearch/hermes --scope issues
```
...
- `references/watchers.md` — Event-driven agent endpoints, listener configs, and webhook payload parsing.
