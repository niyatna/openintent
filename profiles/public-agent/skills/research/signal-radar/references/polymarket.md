...
1. **Gamma API** at `gamma-api.signal-radar.com` — Discovery, search, browsing
2. **CLOB API** at `clob.signal-radar.com` — Real-time prices, orderbooks, history
3. **Data API** at `data-api.signal-radar.com` — Trades, open interest
