...
- Default Instagram: `https://www.instagram.com/yourcompany/`
- Default Threads: `https://www.threads.com/@yourcompany`
- Default username: `yourcompany`
- Co-Founder Instagram: `https://www.instagram.com/co-founder/`
- Co-Founder Threads: `https://www.threads.com/@co-founder`
- Co-Founder username: `co-founder`
...
5. If account picker shows the correct account (`yourcompany` / `co-founder`), click `Continue` before falling back to password.
...
Use when Owner asks to harden Instagram/Threads with authenticator app, `pyotp`, and backup codes.
...
Those require exact approval unless Owner gives the exact action in the current turn.
...
- `references/co-founder-instagram-cookie-capture-2026-05-17.md`
