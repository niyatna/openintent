...
7. Rhetorical format transformation
   ...
   * Convert explainatory texts into storytelling
...
This skill now covers aggressive rewriting after weaker writing-polish stubs were removed.

Choose one mode before rewriting:

| Mode | Use for | Output |
|---|---|---|
| Clean polish | grammar/clarity cleanup | same structure, sharper sentences |
| Human voice | AI-looking prose | less symmetry, more real rhythm |
| Conversion rewrite | landing/email/ad copy | clearer value, stronger CTA, proof discipline |
| Founder voice | Owner public writing | direct, alive, not corporate |
| Operator memo | Default docs/memos | terse, structured, evidence-first |
| Essay upgrade | essays/long-form | stronger thesis, transitions, argument flow |
