# Reference: codegraph-codebase-analysis
...
- Optional: `pygount` for language-breakdown stats (see the `codegraph-codebase-analysis` skill).
...
cat > "$OUTPUT_DIR/.codewiki-state.json" <<EOF
{
  ...
  "generator": "hermes codegraph-codebase-analysis skill v0.1.0",
  "modules_documented": []
}
EOF
```
...
If the user says "do the whole thing exhaustively", believe them — but ballpark the cost first: "this repo has ~340 source files, comprehensive playwright-pro will be expensive — confirm?"
