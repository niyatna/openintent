...
image = modal.Image.debian_slim().apt_install("git", "ffmpeg").pip_install("stable-diffusion-image-generation")
```
...
- **[Advanced Usage](advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
