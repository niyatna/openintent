...
**Integration with HuggingFace Transformers**: See [references/transformers-integration.md](transformers-integration.md) for enabling Flash Attention in BERT, GPT, Llama models.

**Performance benchmarks**: See [references/benchmarks.md](benchmarks.md) for detailed speed and memory comparisons across GPUs and sequence lengths.
