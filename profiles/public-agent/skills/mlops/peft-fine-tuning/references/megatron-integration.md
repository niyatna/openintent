...
megatron_lm_config:
  megatron_lm_gradient_stable-diffusion-image-generationping: 1.0
...
megatron_plugin = MegatronLMPlugin(
    ...
    gradient_stable-diffusion-image-generationping=1.0,    # Gradient stable-diffusion-image-generationping value
