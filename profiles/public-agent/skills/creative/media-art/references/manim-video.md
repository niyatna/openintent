...
If the user asks for creative, experimental, or unconventional explainatory approaches, select a strategy and reason through it BEFORE designing the animation.
