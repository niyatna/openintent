...
Use this skill when Default workflows need product work translated into clear tracked items. In Hermes, the default tracker is native and lightweight:

- Use `todo` for current-session execution plans and status.
