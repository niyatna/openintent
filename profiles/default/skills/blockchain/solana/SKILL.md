...
- User asks "what's the price of JUP/SOL?"
...
python3 ~/.hermes/skills/blockchain/solana/scripts/solana_client.py price EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v
```

Known symbols: SOL, USDC, USDT, JUP, WETH, JTO, mSOL, stSOL,
PYTH, HNT, RNDR, W, TNSR, DRIFT, bSOL, JLP.
