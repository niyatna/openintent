...
client = outlines.from_anthropic(
    Anthropic(),
    mode=outlines.Mode.JSON  # JSON mode
)
...
```python
# Single-use client
with outlines.from_anthropic(Anthropic()) as client:
...
- **Documentation**: https://python.useoutlines.com
- **GitHub**: https://github.com/jxnl/outlines (15k+ stars)
- **Cookbook**: https://python.useoutlines.com/examples
