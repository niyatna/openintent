...
Shared vocabulary for `paseo`. The plan file format and the implement-phase dispatch logic both depend on these definitions. Agents launched by the epic skill read this file to know their role.
...
- Provider: `impl`
- Edits: yes
- Loads: any repo docs the plan or user names — given by path, never inlined
