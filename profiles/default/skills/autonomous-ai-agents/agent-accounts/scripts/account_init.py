...
DEFAULT_ROOT = Path("~/.hermes/private/credentials/agents")
...
def render_account_file(*, owner: str, service: str, account_id_value: str, email: str, username: str, label: str, directory: Path) -> str:
    ...
    lines = [
        ...
        "# Fill secrets locally only after Owner approves the account contract.",
...
def main() -> int:
    ...
    parser.add_argument("--owner", required=True, help="co-founder, default, or another dedicated agent owner")
