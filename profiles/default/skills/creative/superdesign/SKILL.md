---
description: Use when calling the Superdesign MCP daemon, converting design images
  to frontend code, or generating app mockups and brandkit visual boards.
metadata:
  author: Company
  version: 0.0.2
name: superdesign
...
- `references/brandkit.md` — Instruction set for Brandkit
- `references/image-to-code.md` — Instruction set for Image To Code
- `references/imagegen-frontend-mobile.md` — Instruction set for Imagegen Frontend Mobile
- `references/imagegen-frontend-web.md` — Instruction set for Imagegen Frontend Web
