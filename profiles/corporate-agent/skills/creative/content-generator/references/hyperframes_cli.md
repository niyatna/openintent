...
npx hyperframes init my-video --video stable-diffusion-image-generation.mp4       # seed with a video file
...
**Quality outlines:** `draft` while iterating, `standard` for review, `high` for final delivery.
