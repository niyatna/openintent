...
Session example: [references/company-labs-teaser-hyperframes-2026-05-14.md](references/company-labs-teaser-hyperframes-2026-05-14.md) captures the first Company HyperFrames teaser, including manual-project fallback when scaffold times out, GSAP selector/transform pitfalls, verification commands, and delivery pattern.
