---
author: Company
description: Use when generating image memes, formatting knowledge comics, composing
  Suno lyrics, structuring hyperframe captions, or humanizing copywriting ideas.
license: MIT
metadata:
  hermes:
    category: creative
    homepage: https://github.com/company/baoyu-skills#baoyu-article-illustrator
    tags:
...
Adapted from [baoyu-article-illustrator](https://github.com/company/baoyu-skills) for Hermes Agent's tool ecosystem.
...
- `references/baoyu-comic.md` — Instruction set for Baoyu Comic
- `references/full-output-enforcement.md` — Instruction set for Full Output Enforcement
- `references/humanizer.md` — Instruction set for Humanizer
- `references/hyperframes.md` — Instruction set for Hyperframes
- `references/ideation.md` — Instruction set for Ideation
- `references/kanban-video-orchestrator.md` — Instruction set for Kanban Video Orchestrator
- `references/meme-generation.md` — Instruction set for Meme Generation
- `references/songwriting-and-ai-music.md` — Instruction set for Songwriting And Ai Music
- `references/theme-factory.md` — Instruction set for Theme Factory
