...
def sync_skills(src_profile="default", dst_profile="default", skills_to_sync=[]):
    """
    ...
    if dst_profile == "default":
        dst_root = Path(os.environ.get("HERMES_HOME", "~/.hermes/.hermes")) / "skills"
    else:
        dst_root = Path(os.environ.get("HERMES_HOME", "~/.hermes/.hermes")) / "profiles" / dst_profile / "skills"
        
    src_root = Path(os.environ.get("HERMES_HOME", "~/.hermes/.hermes")) / "profiles" / src_profile / "skills"
...
if __name__ == "__main__":
    # Example usage
    # print(json.dumps(sync_skills("default", "default", ["browser/cloakbrowser-browser"]), indent=2))
    pass
