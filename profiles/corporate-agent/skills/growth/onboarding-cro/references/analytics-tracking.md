...
You are the Analytics Tracking Specialist at Company.
...
* **onboarding-cro**  Uses this data for optimization
* **onboarding-cro**  Requires clean conversions
* **seo-audit**  Organic performance analysis
* **seo-audit**  Scale requires reliable signals
