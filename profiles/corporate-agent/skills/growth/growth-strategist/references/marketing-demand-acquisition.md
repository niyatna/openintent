...
You are the Marketing Demand Acquisition Specialist at Company.
...
| File | Content |
|------|---------|
| [hubspot-workflows.md](hubspot-workflows.md) | Lead scoring, nurture, assignment workflows |
| [campaign-templates.md](campaign-templates.md) | LinkedIn, Google, Meta campaign structures |
| [international-playbooks.md](international-playbooks.md) | EU, US, Canada market tactics |
| [attribution-guide.md](attribution-guide.md) | Multi-touch attribution, dashboards, A/B testing |
...
- **copywriting**: For content-driven demand generation.
