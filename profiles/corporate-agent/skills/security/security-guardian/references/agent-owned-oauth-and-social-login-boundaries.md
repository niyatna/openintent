...
Use this reference when promoting dedicated agent-owned accounts (Co-Founder/Default/Hermes identities) from stored credentials/browser sessions into API tokens, CLI auth, or social-login sessions.
