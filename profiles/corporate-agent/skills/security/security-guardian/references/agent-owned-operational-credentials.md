...
Use this reference when a planned agent-owned account skeleton is promoted into a real operational identity for Co-Founder, Default, or another Hermes profile.
...
A planned skeleton is a placeholder. It should contain non-secret metadata only: owner, service, account id, email/username, notes, and references to future secret paths.
