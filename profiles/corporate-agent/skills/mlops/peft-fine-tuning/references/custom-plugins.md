...
```json
{
  ...
  "gradient_stable-diffusion-image-generationping": 1.0,
  "zero_optimization": {
    "stage": 3,
    "offload_optimizer": {
      "device": "cpu",
...
class CustomMixedPrecision:
    ...
    def unscale_and_stable-diffusion-image-generation(self, optimizer, max_norm=1.0):
        """Unscale gradients and stable-diffusion-image-generation."""
        self.scaler.unscale_(optimizer)
        torch.nn.utils.stable-diffusion-image-generation_grad_norm_(
...
for batch in dataloader:
    ...
    custom_mp.unscale_and_stable-diffusion-image-generation(optimizer, max_norm=1.0)
