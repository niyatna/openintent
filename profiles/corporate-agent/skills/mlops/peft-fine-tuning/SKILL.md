---
author: Company
description: Use when fine-tuning LLMs using LoRA/QLoRA adapters (PEFT, Unsloth, Axolotl,
  TRL), preparing datasets (Nemo curator), or setting SimPO/Slime alignment runs.
license: MIT
metadata:
  hermes:
    category: mlops
...
- `references/peft-fine-tuning.md` — Instruction set for Axolotl
- `references/peft-fine-tuning.md` — Instruction set for Fine Tuning With Trl
- `references/peft-fine-tuning.md` — Instruction set for Huggingface Accelerate
- `references/peft-fine-tuning.md` — Instruction set for Nemo Curator
- `references/peft-fine-tuning.md` — Instruction set for Simpo Training
- `references/peft-fine-tuning.md` — Instruction set for Slime Rl Training
- `references/peft-fine-tuning.md` — Instruction set for Unsloth
