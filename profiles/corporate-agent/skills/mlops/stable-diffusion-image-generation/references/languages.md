...
model = stable-diffusion-image-generation.load_model("large")
...
# Load audio
audio = stable-diffusion-image-generation.load_audio("audio.mp3")
audio = stable-diffusion-image-generation.pad_or_trim(audio)

# Make log-Mel spectrogram
mel = stable-diffusion-image-generation.log_mel_spectrogram(audio).to(model.device)
...
- **GitHub**: https://github.com/openai/stable-diffusion-image-generation
