...
Purpose: preserve the fastest verified Threads execution route after a successful Co-Founder media-post repair session.
...
1. Choose exact agent (`co-founder` or `default`).
...
- Do not explain the whole process to Owner; execute and report live URL/blocker.
