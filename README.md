...
### 1.2 Command Dashboard (paperclip-hq)
...
### 1.3 Continuous Corporate Memory (hindsight-api)
...
### 1.4 Agent Workforce Lanes (hermes-agent)
...
### 1.5 Stealth Browser Agent (camoufox-browser)
